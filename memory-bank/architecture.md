...
7. 전체 실거래 점, 연도별 타입 거래 건수, 층 구간별 평균·개별 가격 분포와 고층 대비 가격 비율을 화면에 표시한다.
...
- 층 구간 막대 대표값: A/B/C 타입별 산술평균이며 같은 타입의 개별 실거래 점과 함께 표시
- 고층 대비 가격: 거래별로 같은 연도·같은 타입의 고층 평균을 100%로 환산한 뒤 층 구간별 산술평균
